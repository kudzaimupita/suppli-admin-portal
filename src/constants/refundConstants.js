...
export const GET_ALL_REFUNDS_REQUEST = 'GET_ALL_REFUNDS_REQUEST';
export const GET_ALL_REFUNDS_SUCCESS = 'GET_ALL_REFUNDS_SUCCESS';
export const GET_ALL_REFUNDS_FAIL = 'GET_ALL_REFUNDS_FAIL';
