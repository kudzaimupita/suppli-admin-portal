...
export const GET_ALL_PRODUCT_REVIEWS_REQUEST =
  'GET_ALL_PRODUCT_REVIEWS_REQUEST';
export const GET_ALL_PRODUCT_REVIEWS_SUCCESS =
  'GET_ALL_PRODUCT_REVIEWS_SUCCESS';
export const GET_ALL_PRODUCT_REVIEWS_FAIL = 'GET_ALL_PRODUCT_REVIEWS_FAIL';
